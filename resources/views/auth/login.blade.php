...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <body data-pc-preset="preset-8" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr" data-pc-theme_contrast="" data-pc-theme="light" class="component-page">
        <!-- [ Pre-loader ] start -->
        <div class="loader-bg">
                    ...
                    <div class="card my-5">
                        <div class="card-body">
                            <div class="text-center">
                                <a href="#"><h1 class="text-success">Logistics</h1></a>
